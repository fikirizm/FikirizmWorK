      ...
      <div className="relative w-full max-w-md fik-fade-up">
        ...
        <div className="rounded-2xl border border-zinc-200/80 bg-white p-8 shadow-[0_10px_40px_-12px_rgba(24,24,40,0.15)]">
          <div className="text-center">
            <h1 className="font-heading text-2xl font-bold tracking-tight text-zinc-900">Hesap oluştur</h1>
            <p className="mt-1.5 text-sm text-zinc-500">Fikirizm ekibine katılın.</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-zinc-500">
            ...
            <Link to="/giris" className="font-semibold text-[#5859a3] hover:underline" data-testid="go-login-link">
              Giriş yapın
            </Link>
          </p>
        </div>
